  ...
  <nav :class="classes" class="navbar navbar-expand-lg">
    <div class="container-fluid">
      ...
      <slot name="toggle-button">
        <button aria-controls="navigation-index" @click="toggleMenu" aria-expanded="true" aria-label="Toggle navigation" class="navbar-toggler" data-toggle="collapse" type="button">
      ...
      <CollapseTransition>
        <div class="collapse navbar-collapse justify-content-end show" :class="navbarMenuClasses" v-show="showNavbar" id="navigation">
          <ul class="navbar-nav">
