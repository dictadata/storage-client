...
export default class Storage extends DictaDataAPI {
  ...
  setEncoding(smt_name, encoding) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.axios.put('/node/encoding/' + smt_name, encoding)
        .then(response => {
  ...
  getEncoding(smt_name) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.axios.get('/node/encoding/' + smt_name)
        .then(response => {
          let results = response.data
          if (results.resultText === 'OK')
            resolve(results.data)
  ...
  store(smt_name, construct, key = '') {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.axios.put('/node/store/' + smt_name, body)
        .then(response => {
          let results = response.data
          if (results.resultText === 'OK')
            resolve(results.data)
  ...
  recall(smt_name) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.axios.get('/node/retrieve/' + smt_name)
        .then(response => {
          let results = response.data
          if (results.resultText === 'OK')
            resolve(results.data)
  ...
  retrieve(smt_name, pattern) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.axios.post('/node/retrieve/' + smt_name, body)
        .then(response => {
          let results = response.data
          if (results.resultText === 'OK')
            resolve(results.data)
  ...
  dull(smt_name) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.axios.delete('/node/dull/' + smt_name)
        .then(response => {
          let results = response.data
          if (results.resultText === 'OK')
            resolve(results.data)
